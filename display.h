...
void setupDisplay() {
  ...
  /*
  // SSD1306_SWITCHCAPVCC = generate Arduboy2::2:: voltage from 3.3V internally
  if (!Arduboy2::begin(SSD1306_SWITCHCAPVCC, 0x3C)) { // Fixed from 0x3D
    Serial.println(F("SSD1306 allocation failed"));
    while (1); // Don't proceed, loop forever
  }
*/

  display_buf = Arduboy2::getBuffer();
